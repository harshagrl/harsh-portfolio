  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo('.hero-greeting', { y: 40, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 })
        .fromTo('.hero-name', { y: 60, opacity: 0 }, { y: 0, opacity: 1, duration: 0.9 }, '-=0.4')
        .fromTo('.hero-title', { y: 40, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 }, '-=0.4')
        .fromTo('.hero-desc', { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.7 }, '-=0.3')
        .fromTo('.hero-btns', { y: 30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.7 }, '-=0.3')
        .fromTo('.hero-socials a', { y: 20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.5, stagger: 0.1 }, '-=0.3')
        .fromTo('.hero-image', { scale: 0.8, opacity: 0 }, { scale: 1, opacity: 1, duration: 1, ease: 'back.out(1.5)' }, '-=1')
        .fromTo('.hero-glow', { scale: 0.5, opacity: 0 }, { scale: 1, opacity: 0.6, duration: 1.5, ease: 'power2.out' }, '-=1');
      ...
      <div className="container-custom relative z-10 py-24 md:py-0">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            <h1 ref={titleRef} className="hero-name text-5xl md:text-7xl font-extrabold font-[var(--font-display)] mb-4 leading-tight">
              Harsh{' '}
            ...
            <p className="hero-desc text-text-secondary text-base md:text-lg leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
              Passionate B.Tech CSE student building robust, scalable web applications 
              with React, Node.js, and modern technologies. Turning ideas into 
            ...
            <div className="hero-socials flex gap-4 justify-center lg:justify-start">
              <a href="https://github.com/harshagrl" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://linkedin.com/in/harshkumaragrawal" target="_blank" rel="noopener noreferrer"
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-bg-card border border-border text-text-secondary hover:text-purple-400 hover:border-purple-500 hover:shadow-[0_0_20px_rgba(139,92,246,0.25)] transition-all duration-300">
                <FaLinkedin size={20} />
              </a>
              <a href="mailto:harshkr.agrl@gmail.com"
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-bg-card border border-border text-text-secondary hover:text-purple-400 hover:border-purple-500 hover:shadow-[0_0_20px_rgba(139,92,246,0.25)] transition-all duration-300">
                <FaEnvelope size={20} />
              </a>
              <a href="tel:+919534214839"
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-bg-card border border-border text-text-secondary hover:text-purple-400 hover:border-purple-500 hover:shadow-[0_0_20px_rgba(139,92,246,0.25)] transition-all duration-300">
                <FaPhone size={18} />
              </a>
            </div>
          ...
          <div className="flex-shrink-0 relative">
            <div className="hero-image relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              ...
              {/* Orbit ring */}
              <div className="absolute inset-[-20px] rounded-full border border-purple-500/20 animate-spin" style={{ animationDuration: '15s' }} />
              <div className="absolute inset-[-40px] rounded-full border border-purple-500/10 animate-spin" style={{ animationDuration: '25s', animationDirection: 'reverse' }} />
            </div>
          </div>
        </div>
      </div>
